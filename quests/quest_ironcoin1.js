...
module.exports = {
  name: "quest_ironcoin1",
  description: "says quest_ironcoin1!",
  execute(message, args) {
    //quest_ironcoin1
    console.log("entered quest_ironcoin1 command");
    var member;
    ...
    message
      ...
      .then((collected) => {
        ...
        if (question == 0 && reaction.emoji.name === "1️⃣") {
          ...
          member.roles.remove("726599861730017311");
          let embed = new Discord.MessageEmbed()
            .setTitle(member.user.username + " ...a girl is not ready...")
            .setDescription(
              "Only those who are deemed ready, can make a trip to Braavos."
            )
            .setColor("GREY")
            .setTimestamp()
            .attachFiles(["./assets/girlnotready.png"])
            .setThumbnail("attachment://girlnotready.png");
          chan.send(embed);
        }
      })
      .catch((collected) => {
