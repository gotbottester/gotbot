    ...
    message
      ...
      .then(async (collected) => {
        ...
        if (question == 0 && reaction.emoji.name === "1️⃣") {
          ...
          member.roles.add("713409866764517517"); //red priestess
          member.roles.remove("736100797972086837"); //redpriestess quest role
          await roles.HouseRolesRemover(member);
          let embed = new Discord.MessageEmbed()
            .setTitle(
              member.user.username +
                " has been chosen by the Lord of Light to become a Red Priestess!"
            )
            .setDescription(
          ...
          message.channel.send(
            "The Lord of Light deems you not ready for the art of Blood Magic."
          );
          member.roles.remove("736100797972086837");
          let embed = new Discord.MessageEmbed()
            .setTitle(
            ...
            .setDescription("Only those who pray true can learn the dark arts.")
            .setColor("RED")
            .setTimestamp()
